...
export const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Toutes nos locations partent exclusivement du Port de La Flotte. Pour les permis, vous avez le choix entre le Port de La Flotte ou le Port des Minimes à La Rochelle pour vos 2h de pratique."
  }
];
